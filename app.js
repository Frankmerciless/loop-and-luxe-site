const products = [
  ...
  { id: 'antique-pendant-02', name: 'Antique Pendant Variant 02', note: 'A slightly different antique silhouette in the same heritage family', price: 999, image: 'product-images/Antique PENDENT PR999 (2).jpeg' },
  { id: 'antique-pendant-04', name: 'Antique Pendant Variant 04', note: 'A distinct antique pendant variation in the same collection', price: 999, image: 'product-images/Antique PENDENT PR999 (4).jpeg' },
  { id: 'antique-pendant-05', name: 'Antique Pendant Variant 05', note: 'A refined alternate antique pendant with a soft artisanal look', price: 999, image: 'product-images/Antique PENDENT PR999 (5).jpeg' },
  { id: 'antique-pendant-06', name: 'Antique Pendant Variant 06', note: 'Another antique pendant variation with classic detailing', price: 999, image: 'product-images/Antique PENDENT PR999 (6).jpeg' },
  { id: 'antique-pendant-07', name: 'Antique Pendant Variant 07', note: 'A statement antique pendant variation with a rich crafted finish', price: 999, image: 'product-images/Antique PENDENT PR999 (7).jpeg' },
  ...
  { id: 'ear-cuff-700-second', name: 'Ear Cuff Variant 02', note: 'Alternate ear cuff silhouette in the same handcrafted finish', price: 700, image: 'product-images/Ear Cuff 700  second.jpeg' },
  { id: 'ear-cuff-700-third', name: 'Ear Cuff Variant 03', note: 'Third ear cuff variation with a more dramatic shape', price: 700, image: 'product-images/Ear Cuff 700  third.jpeg' },
  { id: 'ear-cuff-700-first', name: 'Ear Cuff Variant 01', note: 'A refined first ear cuff variation with a luxe profile', price: 700, image: 'product-images/Ear Cuff 700 first.jpeg' },
