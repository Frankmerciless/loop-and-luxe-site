const products = [
  { id: 'dusk-cuff', name: 'Pearl Dusk Cuff', note: 'Festive cuff with sculpted pearl detail', price: 1500, image: 'product-01.jpg' },
  { id: 'bloom-necklace', name: 'Brass Bloom Necklace', note: 'Soft fringe necklace in antique brass', price: 1800, image: 'product-02.jpg' },
  { id: 'vine-earrings', name: 'Crescent Vine Earrings', note: 'Lightweight statement pair with textured finish', price: 1950, image: 'product-03.jpg' },
  { id: 'noir-drops', name: 'Noir Pearl Drops', note: 'Handmade pearl drops with a luxe evening mood', price: 2200, image: 'product-04.jpg' },
  { id: 'golden-bangle', name: 'Golden Leaf Bangle', note: 'A refined statement piece with hand-embellished charm', price: 2450, image: 'product-05.jpg' },
  { id: 'violet-set', name: 'Violet Thread Set', note: 'A tonal layered edit with a soft romantic palette', price: 2700, image: 'product-06.jpg' },
  { id: 'heritage-set', name: 'Heritage Coin Set', note: 'A collectible ensemble inspired by heirloom detailing', price: 2850, image: 'product-07.jpg' },
  { id: 'royal-fringe', name: 'Royal Fringe Necklace', note: 'Statement layering necklace with a dramatic silhouette', price: 3000, image: 'product-08.jpg' }
];
